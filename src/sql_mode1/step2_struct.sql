...
BEGIN
	...
	SELECT id INTO q_id FROM tstore.term WHERE term=p_name AND fk_ns=p_ns;
...
BEGIN
	...
	IF r_id IS NULL THEN
		INSERT INTO tstore.ns (label,description,lang) VALUES (q_label,$3,$2) RETURNING nsid INTO r_id;
	END IF;
	RETURN r_id;
END;
$f$ LANGUAGE PLpgSQL;
